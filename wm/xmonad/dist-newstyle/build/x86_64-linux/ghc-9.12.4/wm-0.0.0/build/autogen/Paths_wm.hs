...
-- at runtime using the environment variable wm_bindir.
...
-- environment variable wm_libdir.
...
-- using the environment variable wm_dynlibdir.
...
-- runtime using the environment variable wm_datadir.
...
-- using the environment variable wm_sysconfdir.
...
bindir     = "/home/indigo/.cabal/bin"
libdir     = "/home/indigo/.cabal/lib/x86_64-linux-ghc-9.12.4-3251/wm-0.0.0-inplace"
dynlibdir  = "/home/indigo/.cabal/lib/x86_64-linux-ghc-9.12.4-3251"
datadir    = "/home/indigo/.cabal/share/x86_64-linux-ghc-9.12.4-3251/wm-0.0.0"
libexecdir = "/home/indigo/.cabal/libexec/x86_64-linux-ghc-9.12.4-3251/wm-0.0.0"
sysconfdir = "/home/indigo/.cabal/etc"

getBinDir     = catchIO (getEnv "wm_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "wm_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "wm_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "wm_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "wm_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "wm_sysconfdir") (\_ -> return sysconfdir)
